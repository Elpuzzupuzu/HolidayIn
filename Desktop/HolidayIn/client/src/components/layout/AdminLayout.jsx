...
export default function AdminLayout() {
  ...
  const navigationItems = [
    ...
    {
      name: "Buscar por Departamento",
      href: "/admin/logs/findbyID",
      icon: (
        <svg className="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5s3.332.477 4.5 1.253v13C19.832 18.477 18.246 18 16.5 18s-3.332.477-4.5 1.253" />
        </svg>
    ...
    // --- NUEVA RUTA PARA CONSULTA HORARIOS ---
    {
      name: "Consulta Horarios", // Nombre que aparecerá en el menú
      href: "/admin/horarios", // La ruta base a la que navegará
      icon: (
        <svg className="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  const getCurrentPageTitle = () => {
    // This logic might need refinement if your URLs don't match exactly.
    // For `/admin/horarios/:deptoId/:numeroSemana`, you might want to show "Consulta Horarios".
