...
// Importa el componente EmployeeSearchComponent que acabas de modificar
...
const HorarioModal = ({ colaborador, onClose }) => {
    ...
    useEffect(() => {
        // Despachar getWorkedHoursBetweenDates (esto permanece igual)
        if (colaborador && colaborador.id && colaborador.numeroSemana && colaborador.anioSemana &&
            ...
            console.warn("⚠️ HorarioModal: No se despacha getWorkedHoursBetweenDates. Faltan datos requeridos:", {
    ...
    // --- LÓGICA PARA PROCESAR HORARIOS Y COMPARAR (SIN CAMBIOS) ---
                ...
                <div className="modal-body">
                    ...
                    <div className="colaborador-info">
                        <div className="info-item">
                            ...
                            <EmployeeSearchComponent employeeNumber={colaborador.id} />
